...
IceHockeyMatch _$IceHockeyMatchFromJson(Map<String, dynamic> json) {
  return _IceHockeyMatch.fromJson(json);
}

/// @nodoc
mixin _$IceHockeyMatch {
  ...
  /// Per-period breakdown keyed by "p1".."p3" plus "ft" (total goals).
  ...
  /// Serializes this IceHockeyMatch to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of IceHockeyMatch
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $IceHockeyMatchCopyWith<IceHockeyMatch> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $IceHockeyMatchCopyWith<$Res> {
  factory $IceHockeyMatchCopyWith(
    IceHockeyMatch value,
    $Res Function(IceHockeyMatch) then,
  ) = _$IceHockeyMatchCopyWithImpl<$Res, IceHockeyMatch>;
  @useResult
  $Res call({
    String id,
    int statusId,
...
/// @nodoc
class _$IceHockeyMatchCopyWithImpl<$Res, $Val extends IceHockeyMatch>
    implements $IceHockeyMatchCopyWith<$Res> {
  _$IceHockeyMatchCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$IceHockeyMatchImplCopyWith<$Res>
    implements $IceHockeyMatchCopyWith<$Res> {
  factory _$$IceHockeyMatchImplCopyWith(
    _$IceHockeyMatchImpl value,
    $Res Function(_$IceHockeyMatchImpl) then,
  ) = __$$IceHockeyMatchImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$$IceHockeyMatchImplCopyWithImpl<$Res>
    extends _$IceHockeyMatchCopyWithImpl<$Res, _$IceHockeyMatchImpl>
    implements _$$IceHockeyMatchImplCopyWith<$Res> {
  __$$IceHockeyMatchImplCopyWithImpl(
    _$IceHockeyMatchImpl _value,
    $Res Function(_$IceHockeyMatchImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$IceHockeyMatchImpl extends _IceHockeyMatch {
  const _$IceHockeyMatchImpl({
    required this.id,
  ...
  factory _$IceHockeyMatchImpl.fromJson(Map<String, dynamic> json) =>
      _$$IceHockeyMatchImplFromJson(json);
  ...
  @override
  String toString() {
    return 'IceHockeyMatch(id: $id, statusId: $statusId, matchTimeSim: $matchTimeSim, homeName: $homeName, homeLogo: $homeLogo, homeScore: $homeScore, awayName: $awayName, awayLogo: $awayLogo, awayScore: $awayScore, leagueName: $leagueName, leagueLogo: $leagueLogo, matchTime: $matchTime, scores: $scores, oddsEuro: $oddsEuro, statusDescription: $statusDescription)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$IceHockeyMatchImplCopyWith<_$IceHockeyMatchImpl> get copyWith =>
      __$$IceHockeyMatchImplCopyWithImpl<_$IceHockeyMatchImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$IceHockeyMatchImplToJson(this);
  }
}

abstract class _IceHockeyMatch extends IceHockeyMatch {
  const factory _IceHockeyMatch({
  ...
  const _IceHockeyMatch._() : super._();

  factory _IceHockeyMatch.fromJson(Map<String, dynamic> json) =
      _$IceHockeyMatchImpl.fromJson;
