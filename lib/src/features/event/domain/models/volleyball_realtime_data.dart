...
@immutable
class VolleyballRealtimeData implements SportRealtimeData {
  const VolleyballRealtimeData({
    required this.id,
  ...
  /// Per-set scores: index 0 = set 1, etc.
  ...
  factory VolleyballRealtimeData.fromJson(Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) =>
      ...
      other is VolleyballRealtimeData &&
          id == other.id &&
