...
@immutable
class BadmintonPlayerDetailInfo {
  const BadmintonPlayerDetailInfo({
...
@immutable
class BadmintonLeagueDetailInfo {
  const BadmintonLeagueDetailInfo({
    required this.enName,
    required this.cnName,
    required this.logo,
  });
...
@immutable
class BadmintonMatchDetail {
  const BadmintonMatchDetail({
    required this.id,
  ...
  final BadmintonPlayerDetailInfo homeInfo;
  final BadmintonPlayerDetailInfo awayInfo;
  final BadmintonLeagueDetailInfo leagueInfo;
  final int? bestof;
  ...
  factory BadmintonMatchDetail.fromJson(Map<String, dynamic> json) {
    ...
    return BadmintonMatchDetail(
      ...
      homeInfo: BadmintonPlayerDetailInfo(
      ...
      awayInfo: BadmintonPlayerDetailInfo(
      ...
      leagueInfo: BadmintonLeagueDetailInfo(
