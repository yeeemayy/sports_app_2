...
BasketballMatch _$BasketballMatchFromJson(Map<String, dynamic> json) {
  return _BasketballMatch.fromJson(json);
}

/// @nodoc
mixin _$BasketballMatch {
  ...
  String? get counterTiming => throw _privateConstructorUsedError;
  ...
  /// Serializes this BasketballMatch to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BasketballMatch
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BasketballMatchCopyWith<BasketballMatch> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BasketballMatchCopyWith<$Res> {
  factory $BasketballMatchCopyWith(
    BasketballMatch value,
    $Res Function(BasketballMatch) then,
  ) = _$BasketballMatchCopyWithImpl<$Res, BasketballMatch>;
  @useResult
  $Res call({
    String id,
    int statusId,
...
/// @nodoc
class _$BasketballMatchCopyWithImpl<$Res, $Val extends BasketballMatch>
    implements $BasketballMatchCopyWith<$Res> {
  _$BasketballMatchCopyWithImpl(this._value, this._then);
      ...
      _value.copyWith(
            ...
            matchTime: freezed == matchTime
                ...
                : matchTime // ignore: cast_nullable_to_non_nullable
                      as int?,
            counterTiming: freezed == counterTiming
                ? _value.counterTiming
                : counterTiming // ignore: cast_nullable_to_non_nullable
                      as String?,
...
abstract class _$$BasketballMatchImplCopyWith<$Res>
    implements $BasketballMatchCopyWith<$Res> {
  factory _$$BasketballMatchImplCopyWith(
    _$BasketballMatchImpl value,
...
class __$$BasketballMatchImplCopyWithImpl<$Res>
    extends _$BasketballMatchCopyWithImpl<$Res, _$BasketballMatchImpl>
    implements _$$BasketballMatchImplCopyWith<$Res> {
  __$$BasketballMatchImplCopyWithImpl(
    _$BasketballMatchImpl _value,
    $Res Function(_$BasketballMatchImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$BasketballMatchImpl extends _BasketballMatch {
  ...
  @override
  String toString() {
    return 'BasketballMatch(id: $id, statusId: $statusId, matchTimeSim: $matchTimeSim, homeName: $homeName, homeLogo: $homeLogo, homeScore: $homeScore, awayName: $awayName, awayLogo: $awayLogo, awayScore: $awayScore, leagueName: $leagueName, leagueLogo: $leagueLogo, matchTime: $matchTime, counterTiming: $counterTiming, runningTime: $runningTime, oddsEuro: $oddsEuro, statusDescription: $statusDescription)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.counterTiming, counterTiming) ||
                other.counterTiming == counterTiming) &&
  ...
  Map<String, dynamic> toJson() {
    return _$$BasketballMatchImplToJson(this);
  }
}

abstract class _BasketballMatch extends BasketballMatch {
  const factory _BasketballMatch({
  ...
  const _BasketballMatch._() : super._();

  factory _BasketballMatch.fromJson(Map<String, dynamic> json) =
