...
@immutable
class VolleyballTeamDetailInfo {
  const VolleyballTeamDetailInfo({
  ...
  /// Point scores per set: [p1, p2, p3, p4, p5]
  final List<int> setScores;
}

@immutable
class VolleyballLeagueDetailInfo {
  const VolleyballLeagueDetailInfo({
    required this.enName,
    required this.cnName,
    required this.logo,
  });
...
@immutable
class VolleyballMatchDetail {
  const VolleyballMatchDetail({
    required this.id,
  ...
  final VolleyballTeamDetailInfo homeInfo;
  final VolleyballTeamDetailInfo awayInfo;
  final VolleyballLeagueDetailInfo leagueInfo;
  ...
  factory VolleyballMatchDetail.fromJson(Map<String, dynamic> json) {
    ...
    return VolleyballMatchDetail(
      ...
      homeInfo: VolleyballTeamDetailInfo(
      ...
      awayInfo: VolleyballTeamDetailInfo(
      ...
      leagueInfo: VolleyballLeagueDetailInfo(
