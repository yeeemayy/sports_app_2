...
part 'am_football_match.freezed.dart';
part 'am_football_match.g.dart';

@freezed
class AmFootballMatch with _$AmFootballMatch implements SportMatch {
  const AmFootballMatch._();

  const factory AmFootballMatch({
    required String id,
  ...
  factory AmFootballMatch.fromJson(Map<String, dynamic> json) =>
      _$AmFootballMatchFromJson(json);

  factory AmFootballMatch.fromSportJson(Map<String, dynamic> json) {
