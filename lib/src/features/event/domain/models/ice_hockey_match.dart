...
part 'ice_hockey_match.freezed.dart';
part 'ice_hockey_match.g.dart';

@freezed
class IceHockeyMatch with _$IceHockeyMatch implements SportMatch {
  const IceHockeyMatch._();

  const factory IceHockeyMatch({
    required String id,
  ...
  factory IceHockeyMatch.fromJson(Map<String, dynamic> json) => _$IceHockeyMatchFromJson(json);

  factory IceHockeyMatch.fromSportJson(Map<String, dynamic> json) {
