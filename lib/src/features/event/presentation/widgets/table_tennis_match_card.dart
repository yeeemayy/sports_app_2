...
class TableTennisMatchCard extends ConsumerWidget {
  ...
  static List<int> _homeSets(TableTennisMatch m) {
  ...
  static List<int> _awaySets(TableTennisMatch m) {
    final scores = m.scores;
    if (scores == null) return [];
    final sets = <int>[];
    for (var i = 1; i <= 7; i++) {
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: _TableTennisScoreDisplay(
...
class _TableTennisScoreDisplay extends StatelessWidget {
  const _TableTennisScoreDisplay({
