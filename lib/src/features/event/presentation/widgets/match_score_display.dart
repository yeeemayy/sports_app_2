...
///
/// Shows a dash when [isNotStarted] is true. Colours the score with [AppColors.primary]
...
class MatchScoreDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final scoreColor = color ?? (isLive ? AppColors.primary : AppTheme.of(context).baseText);
    return RichText(
      text: TextSpan(
        style: context.textTheme.titleMedium?.copyWith(
