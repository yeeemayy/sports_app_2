...
class FanPredictionCard extends ConsumerWidget {
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                'prediction.title'.tr(),
                style: AppTextStyles.display(14, context).copyWith(color: colors.text),
              ),
              const Spacer(),
              if (hasVoted)
                Text(
                  'prediction.picks'.tr(namedArgs: {'n': _formatCount(tally.total)}),
              ...
              child: _VoteBar(
                ...
                onTap: canVote
                    ? () => ref
                          ...
                          .vote(matchId: matchId, uid: firebaseUid, pick: opt.pick)
                    : null,
                colors: colors,
                context: context,
              ),
          ...
          if (isMatchEnded)
            Padding(
              ...
              child: Text(
                ...
                style: AppTextStyles.mono(9).copyWith(color: colors.text3, letterSpacing: 0.1 * 9),
  ...
  List<_PredictionOption> _buildOptions(String home, String away) => [
    ...
    _PredictionOption(pick: PredictionPick.draw, label: 'prediction.draw'.tr()),
    _PredictionOption(
            ...
            children: [
              ...
              if (hasVoted)
                FractionallySizedBox(
                  ...
                  child: Container(color: isSelected ? barColor : colors.lineStrong),
                ),
                  ...
                  children: [
                    ...
                    if (hasVoted)
                      Text(
                        ...
                        style: AppTextStyles.mono(
                          11,
                        ).copyWith(color: isSelected ? Colors.white : textColor),
                      ),
                  ],
                ),
              ),
