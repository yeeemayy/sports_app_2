...
class FanPredictionCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLoggedIn =
        ref.watch(authNotifierProvider).valueOrNull?.user != null;
      ...
      child: Column(
        ...
        children: [
          ...
          ...options.map((opt) {
            ...
            final canVote =
                !isMatchEnded && firebaseUid != null && isLoggedIn && !hasVoted;
          ...
          if (isMatchEnded)
            Padding(
              ...
              child: Text(
                ...
                style: AppTextStyles.mono(
                  9,
                ).copyWith(color: colors.text3, letterSpacing: 0.1 * 9),
...
class _VoteBar extends StatelessWidget {
  ...
  Widget build(BuildContext _) {
    ...
    final textColor = (hasVoted && isSelected)
