...
import 'package:shenghaotiyu/src/features/anchor/presentation/anchor_detail_screen.dart';
import 'package:shenghaotiyu/src/features/home/presentation/anchor_list_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/am_football_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/basketball_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/cricket_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/domain/models/football_match.dart';
import 'package:shenghaotiyu/src/features/event/presentation/football_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/badminton_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/baseball_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/ice_hockey_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/table_tennis_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/tennis_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/volleyball_match_detail_screen.dart';
import 'package:shenghaotiyu/src/features/auth/presentation/forgot_password_screen.dart';
import 'package:shenghaotiyu/src/features/auth/presentation/login_screen.dart';
import 'package:shenghaotiyu/src/features/auth/presentation/providers/auth_notifier.dart';
import 'package:shenghaotiyu/src/features/auth/presentation/register_screen.dart';
import 'package:shenghaotiyu/src/features/event/presentation/event_screen.dart';
...
import 'package:shenghaotiyu/src/features/league/presentation/country_leagues_screen.dart';
import 'package:shenghaotiyu/src/features/league/presentation/hot_leagues_browse_screen.dart';
import 'package:shenghaotiyu/src/features/league/presentation/league_detail_screen.dart';
import 'package:shenghaotiyu/src/features/league/presentation/league_screen.dart';
import 'package:shenghaotiyu/src/features/league/presentation/player_detail_screen.dart';
import 'package:shenghaotiyu/src/features/league/presentation/search_leagues_screen.dart';
import 'package:shenghaotiyu/src/features/league/presentation/team_detail_screen.dart';
import 'package:shenghaotiyu/src/features/home/presentation/anchor_screen.dart';
import 'package:shenghaotiyu/src/features/news/presentation/news_category_screen.dart';
import 'package:shenghaotiyu/src/features/news/presentation/news_detail_screen.dart';
import 'package:shenghaotiyu/src/features/video/presentation/video_detail_screen.dart';
import 'package:shenghaotiyu/src/features/news/presentation/news_screen.dart';
import 'package:shenghaotiyu/src/features/favourites/presentation/favourites_screen.dart';
import 'package:shenghaotiyu/src/features/watchlist/presentation/watchlist_screen.dart';
import 'package:shenghaotiyu/src/features/profile/presentation/edit_profile_screen.dart';
import 'package:shenghaotiyu/src/features/profile/presentation/profile_screen.dart';
import 'package:shenghaotiyu/src/shared_widgets/web_view_screen.dart';
import 'package:shenghaotiyu/src/routes/app_routes.dart';
import 'package:shenghaotiyu/src/routes/app_wrapper.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          final extra = state.extra;
          final category = extra is ({String title, String keyword})
              ? extra
              : (title: 'news.section.latest', keyword: '');
      ...
      GoRoute(
        ...
        builder: (context, state) => VideoDetailScreen(
          ...
          lastPage:
              int.tryParse(state.uri.queryParameters['lastPage'] ?? '') ?? 1,
        ),
      ),
      GoRoute(
